//
//  MDGPUImageFloatingBarsEffectFilterGroup.h
//  MomoChat
//
...
@interface MDGPUImageFloatingBarsEffectFilterGroup : GPUImageFilterGroup <MDGPUImageTranslationAnimationProtocol, MDGPUImageEffectFilterProtocol>
