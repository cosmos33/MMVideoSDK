//
//  MDGPUImageFuzzyZoomOutFilterGroup.h
//  MomoChat
//
...
@interface MDGPUImageFuzzyZoomOutFilterGroup : GPUImageFilterGroup <MDGPUImageTranslationAnimationProtocol, MDGPUImageEffectFilterProtocol>
